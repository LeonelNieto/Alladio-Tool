...
<Project Type="Project" LVVersion="21008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ERD_Read_List_Builder.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/ERD_Read_List_Builder.vi"/>
			<Item Name="ERDList.ctl" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/type defs/ERDList.ctl"/>
			<Item Name="Error_Clearing.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/Error_Clearing.vi"/>
			<Item Name="Error_Command.ctl" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/type defs/Error_Command.ctl"/>
			<Item Name="Error_Control.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/Error_Control.vi"/>
			...
			<Item Name="Faults_To_String_Array.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/Faults_To_String_Array.vi"/>
			<Item Name="FGV_GEA2_Ref.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/FGV_GEA2_Ref.vi"/>
			...
			<Item Name="Get NEW FI Set Max.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/Get NEW FI Set Max.vi"/>
			<Item Name="Get User Filename and Path.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/Get User Filename and Path.vi"/>
			...
			<Item Name="HEUI_Event_FGV.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/HEUI_Event_FGV.vi"/>
			...
			<Item Name="TimeStamp to String Array.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/TimeStamp to String Array.vi"/>
			<Item Name="UI Loop Error and Que Setup.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/UI Loop Error and Que Setup.vi"/>
			...
			<Item Name="Write _To_CSV_File.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/Write _To_CSV_File.vi"/>
			<Item Name="Write _To_TXT_File.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/Write _To_TXT_File.vi"/>
			<Item Name="Write_Header_FGV.vi" Type="VI" URL="../../Dryer Tool (Commercial 2)/JL Dryer Tool Support/sub vis/Write_Header_FGV.vi"/>
		</Item>
